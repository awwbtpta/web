 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e5(e,t,r=!1){if((0,n.rh)(e.app))return Promise.reject(g(e));let i="signIn",s=await e2(e,i,t),a=await e0._fromIdTokenResponse(e,i,s);return r||await e._updateCurrentUser(a.user),a}async function e6(e,t){return e5(ey(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e8(e){let t=ey(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}async function e7(e,t,r){if((0,n.rh)(e.app))return Promise.reject(g(e));let i=ey(e),s=eP(i,{returnSecureToken:!0,email:t,password:r,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",eZ),a=await s.catch(t=>{throw"auth/password-does-not-meet-requirements"===t.code&&e8(e),t}),o=await e0._fromIdTokenResponse(i,"signIn",a);return await i._updateCurrentUser(o.user),o}function te(e,t,r){return(0,n.rh)(e.app)?Promise.reject(g(e)):e6((0,s.m9)(e),eK.credential(t,r)).catch(async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&e8(e),t})}function tt(e,t){return tr((0,s.m9)(e),null,t)}async function tr(e,t,r){let{auth:i}=e,n={idToken:await e.getIdToken(),returnSecureToken:!0};t&&(n.email=t),r&&(n.password=r);let s=await $(e,eN(i,n));await e._updateTokensIfNecessary(s,!0)}function ti(e,t,r,i){return(0,s.m9)(e).onAuthStateChanged(t,r,i)}function tn(e){return(0,s.m9)(e).signOut()}async function ts(e){return(0,s.m9)(e).delete()}new WeakMap;let ta="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tP{constructor(e){this.providerId=tP.PROVIDER_ID,this.auth=ey(e)}verifyPhoneNumber(e,t){return tR(this.auth,e,(0,s.m9)(t))}static credential(e,t){return e$._fromVerification(e,t)}static credentialFromResult(e){return tP.credentialFromTaggedObject(e)}static credentialFromError(e){return tP.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;let{phoneNumber:t,temporaryProof:r}=e;return t&&r?e$._fromTokenResponse(t,r):null}}tP.PROVIDER_ID="phone",tP.PHONE_SIGN_IN_METHOD="phone";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tC extends eb{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return eF(e,this._buildIdpRequest())}_linkToIdToken(e,t){return eF(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return eF(e,this._buildIdpRequest())}_buildIdpRequest(e){let t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function tO(e){return e5(e.auth,new tC(e),e.bypassAuthState)}function tb(e){let{auth:t,user:r}=e;return _(r,t,"internal-error"),e4(r,new tC(e),e.bypassAuthState)}async function tN(e){let{auth:t,user:r}=e;return _(r,t,"internal-error"),e9(r,new tC(e),e.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tG=new T(3e4,6e4);function tJ(){let e=tp().___jsl;if(null==e?void 0:e.H){for(let t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}}let tB=null,tX=new T(5e3,15e3),tY={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},tQ=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);async function tZ(e){let t=await (tB=tB||new Promise((t,r)=>{var i,n,s,a;function o(){tJ(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{tJ(),r(f(e,"network-request-failed"))},timeout:tG.get()})}if(null===(n=null===(i=tp().gapi)||void 0===i?void 0:i.iframes)||void 0===n?void 0:n.Iframe)t(gapi.iframes.getContext());else if(null===(s=tp().gapi)||void 0===s?void 0:s.load)o();else{let t=ek("iframefcb");return tp()[t]=()=>{gapi.load?o():r(f(e,"network-request-failed"))},(a=`${eE.gapiScript}?onload=${t}`,eE.loadJS(a)).catch(e=>r(e))}}).catch(e=>{throw tB=null,e})),r=tp().gapi;return _(r,e,"internal-error"),t.open({where:document.body,url:function(e){let t=e.config;_(t.authDomain,e,"auth-domain-config-required");let r=t.emulator?E(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,i={apiKey:t.apiKey,appName:e.name,v:n.Jn},a=tQ.get(e.config.apiHost);a&&(i.eid=a);let o=e._getFrameworks();return o.length&&(i.fw=o.join(",")),`${r}?${(0,s.xO)(i).slice(1)}`}(e),messageHandlersFilter:r.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:tY,dontclear:!0},t=>new Promise(async(r,i)=>{await t.restyle({setHideOnLeave:!1});let n=f(e,"network-request-failed"),s=tp().setTimeout(()=>{i(n)},tX.get());function a(){tp().clearTimeout(s),r(t)}t.ping(a).then(a,()=>{i(n)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
