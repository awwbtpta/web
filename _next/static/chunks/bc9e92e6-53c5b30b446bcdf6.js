"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[4358],{35002:function(e,t,n){n.d(t,{IO:function(){return i9},JU:function(){return iN},PL:function(){return su},QT:function(){return so},ad:function(){return ib},ar:function(){return i5},hJ:function(){return iA},oe:function(){return sd},pl:function(){return sh},r7:function(){return sc}});var r,i,s,a,o=n(99279),l=n(42680),u=n(19053),h=n(71028),c=n(54565);n(25566);var d=n(9109).Buffer;let f="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function so(e){e=i_(e,iC);let t=i_(e.firestore,iD);return(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ia({next:s=>{t.enqueueAndForget(()=>rM(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new C(I.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new C(I.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rP(new e4(n.path),s,{includeMetadataChanges:!0,ra:!0});return rL(e,a)})(await id(e),e.asyncQueue,t,n,r)),r.promise})(iR(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new sl(e);return new si(e,i,t._key,r,new sr(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class sl extends sn{constructor(e){super(),this.firestore=e}convertBytes(e){return new iL(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iC(this.firestore,null,t)}}function su(e){e=i_(e,iI);let t=i_(e.firestore,iD),n=iR(t),r=new sl(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new C(I.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new rP(n,new ia({next:n=>{t.enqueueAndForget(()=>rM(e,s)),n.fromCache&&"server"===r.source?i.reject(new C(I.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),{includeMetadataChanges:!0,ra:!0});return rL(e,s)})(await id(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sa(t,r,e,n)))}function sh(e,t,n){var r;e=i_(e,iC);let i=i_(e.firestore,iD),s=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return sf(i,[(function(e,t,n,r,i,s={}){let a,o;let l=e.Fu(s.merge||s.mergeFields?2:0,t,n,i);iH("Data must be an object, but it was:",l,r);let u=iQ(r,l);if(s.merge)a=new ea(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=iW(t,r,n);if(!l.contains(i))throw new C(I.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);iZ(e,i)||e.push(i)}a=new ea(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iP(new eL(u),a,o)})(i$(i),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,tk.none())])}function sc(e,t,n,...r){e=i_(e,iC);let i=i_(e.firestore,iD),s=i$(i);return sf(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iM?function(e,t,n,r,i,s){let a=e.Fu(1,t,n),o=[iW(t,r,n)],l=[i];if(s.length%2!=0)throw new C(I.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(iW(t,s[e])),l.push(s[e+1]);let u=[],c=eL.empty();for(let e=o.length-1;e>=0;--e)if(!iZ(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Su(t);if(n instanceof iK)u.push(t);else{let e=iG(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iU(c,new ea(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Fu(1,t,n);iH("Data must be an object, but it was:",i,r);let s=[],a=eL.empty();return Z(r,(e,r)=>{let o=iX(t,e,n);r=(0,h.m9)(r);let l=i.Su(o);if(r instanceof iK)s.push(o);else{let e=iG(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iU(a,new ea(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tk.exists(!0))])}function sd(e){return sf(i_(e.firestore,iD),[new tU(e._key,tk.none())])}function sf(e,t){return function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>rX(await ic(e).then(e=>e.syncEngine),t,n)),n.promise}(iR(e),t)}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iD(new D(t.getProvider("auth-internal")),new L(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new C(I.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ey(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(f,"4.6.1",void 0),(0,o.KN)(f,"4.6.1","esm2017")}()}}]);